...
(function( root, factory ) {
    ...
    const __imports = {
        env: {
            ...
            "__extjs_56a0d381eede6e3724ed54d276314d32ec3e6d8f": function($0, $1, $2) {
                $1 = Module.STDWEB.to_js($1);$2 = Module.STDWEB.to_js($2);Module.STDWEB.from_js($0, (function(){Module.exports.hello = ($1); Module.exports.run_program = ($2);})());
            },
    ...
    function __load( instance ) {
        ...
        if( typeof module !== 'undefined' && module.exports ) {
            ...
            Rust.wasm_demo.exports = Module.exports;
        }
    ...
    if( Module.nodejs ) {
        ...
        const wasm_path = path.join( __dirname, "wasm-demo.wasm" );
        ...
        const __promise = fetch( "wasm-demo.wasm" )
            .then( response => response.arrayBuffer() )
            .then( bytes => WebAssembly.instantiate( bytes, __imports ) )
            .then( results => {
                __load( results.instance );
                console.log( "Finished loading Rust wasm module 'wasm_demo'" );
                return Module.exports;
            })
            .catch( error => {
                console.log( "Error loading Rust wasm module 'wasm_demo':", error );
                throw error;
            });

        Rust.wasm_demo = __promise;
        return __promise;
    }
}));
